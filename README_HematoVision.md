...
- **Team ID**:  LTVIP2026TMIDS53538
- **Team Size**: 4 
- **Team Leader**: Vajrala Zainub 
- **Team Members**:  
  - Venkata Vignesh Nadavaluru  
  - Vattikunta Hemanthi  
  - Murthigari Siri Chandana
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/Zainub013/Hematovision-Advanced-Blood-Cell-Classification-Using-Transfer-Learning
   cd hematovision-app
   ```
